...
int main() {
    ...
    bras.addJoint(make_unique<CJointRevolute>(0.0, -M_PI, M_PI, 0.5));
    bras.addJoint(make_unique<CJointRevolute>(0.3, -M_PI, M_PI, 0.3));
    
    // Pour le prismatique : q_init, q_min, q_max
    bras.addJoint(make_unique<CJointPrismatic>(0.1, 0.0, 0.5));
